                    ...
                    <div class="portfolio-info">
                        ...
                        <div class="row">
                            <div class="col-12 profile_menu" style="text-align:center">
                                ...
                                <?php if(!empty($researchproject->result_array()) || !empty($consultancyproject->result_array())) { ?>
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class='col-sm-12' style="margin-top: 50px;">
                                        <div class="col-12">
                                            <h1 style="text-align: center; font-size: 28px">Research Projects</h1>
                                        </div>
                                        <table id="example" class="table table-striped table-bordered dat_tbl">
                                            <tbody>
                                                <?php if(!empty($researchproject->result_array())) { 
                                                   $i=1; ?>
                                                <?php foreach($researchproject->result_array() as $row) { ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                    ...
                                    <div class='col-sm-12' style="margin-top: 50px;">
                                        <div class="col-12">
                                            <h1 style="text-align: center; font-size: 28px">Consultancy Projects</h1>
                                        </div>
                                        <table id="example" class="table table-striped table-bordered dat_tbl">
                                            <tbody>
                                                <?php if(!empty($consultancyproject->result_array())) { 
                                                   $i=1; ?>
                                                <?php foreach($consultancyproject->result_array() as $row) { ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td style="text-align: justify;"><?php echo $row['project_title']; ?></td>
                                                    <td><?php echo $row['pstatus']; ?></td>
