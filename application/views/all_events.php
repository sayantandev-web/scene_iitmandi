                    ...
                    <div class="portfolio-info">
                        ...
                        <div class="row">
                            ...
                            <div class="homeNews1" style="width: 100%; display: inline-block; float: left; margin: 0px 10px 10px 0px; background: #001730; border-radius: 20px;">
                                <img class="mb-2" src="<?php echo base_url() ?>uploads/events/<?php echo $row['event_image']?>" style="width: 100%;height: 290px;border-radius: 20px 20px 0 0;">
                                <h5 style="line-height: 18px;padding-left: 10px; padding-bottom: 10px;margin-bottom: 5px;">
                                <a href="<?php echo base_url().'event_details/'.$row['slug']; ?>" style="color: #fff;font-size: 16px;text-decoration: none;" target="_blank"><?php echo $string;?></a></h5>
                                <hr>
                            </div>
                            </div>
                            <?php } } ?>
