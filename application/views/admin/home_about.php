                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Home About</h3>
                            </div>
                            <div class="panel-body">
                                <?php echo $this->utilitylib->showMsg();?>
                                <div class="form">
                                    <form class="cmxform form-horizontal tasi-form" id="editForm" method="post" action="admin/Homeabout/home_about" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="location1" class="control-label col-lg-3 col-md-3 col-sm-4">Home About Content</label>
                                            <div class="col-lg-9 col-md-9 col-sm-8">
                                                <textarea class="form-control" type="text" name="description" rows="15"><?php echo strip_tags(@$result[0]['description']); ?></textarea>
                                            </div>
                                        </div>
                                        
                                        <?php if(@$result[0]['homeabt_img'] !=""){ ?>
                                        <div class="form-group">
                                            <label for="about_me" class="control-label col-lg-3 col-md-3 col-sm-4">Image</label>
                                            <div class="col-lg-9 col-md-9 col-sm-8">
                                                <?php if(@$result[0]['homeabt_img']){ ?>
                                                <img src="<?php echo base_url(); ?>uploads/homeabout/thumb/<?php echo @$result[0]['homeabt_img']; ?>" alt="<?php echo @$result[0]['homeabt_img']; ?>">
                                                <?php } else { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9 col-md-9 col-sm-8">
                                                <div class="fileupload btn btn-primary_cust waves-effect waves-light">
                                                    <input type="file" name="homeabt_img" id="homeabt_img" class="upload">
